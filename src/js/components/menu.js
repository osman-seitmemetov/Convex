...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const contract = () => {
        let w = 0,
            outerWidth = parent.offsetWidth - (parseInt(moreWidth) + parseInt(moreMargin) + parseInt(menuMargin) + 100);
    ...
    const expand = () => {
        ...
        let submenuItems = subMenu.querySelectorAll('.menu-sub-item');
    ...
    const checkActive = () => {
        if (subMenu.querySelectorAll('.menu-sub-item').length) {
